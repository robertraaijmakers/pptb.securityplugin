export const UI_TEXT = {
  ...
  bulkUpdateSelect: "Set visible to...",
  bulkUpdateApply: "Set",
  ...
  assignmentSelectUsersForRole: "Check users to assign or uncheck to remove this role, then click Update.",
  assignmentSelectUserRoles: "Select a user to view roles.",
  assignmentSelectRolesForUser: "Check roles to assign or uncheck to remove for this user, then click Update.",
  assignmentSelectRoleTeams: "Select a role to view teams.",
  assignmentSelectTeamsForRole: "Check teams to assign or uncheck to remove this role, then click Update.",
  assignmentSelectTeamRoles: "Select a team to view roles.",
  assignmentSelectRolesForTeam: "Check roles to assign or uncheck to remove for this team, then click Update.",
  unitUsers: "users",
  unitTeams: "teams",
  unitRoles: "roles",
  search: "Search...",
